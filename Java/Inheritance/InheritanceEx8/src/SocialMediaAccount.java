...
class DemoInheritanceSocialMediaAccount
{
	public static void main(String[] args)
	{
		...
		SocialMediaAccount s2 = new SocialMediaAccount("xyz","xyz@gmail.com",true,false,"India",120,25000,4200,"10-01-2022",500000);
		s2.Display();
		...
		InstagramAccount i2 = new InstagramAccount("xyz","xyz@gmail.com",true,false,"India",120,25000,4200,"10-01-2022",500000,15000,500,18,30,75,40);
		i2.Display();
		...
		LinkedInAccount l2 = new LinkedInAccount("xyz","xyz@gmail.com",true,false,"India",120,25000,4200,"10-01-2022",500000,950,1200,35);
		l2.Display();
